...
<Image className="rounded-primary mx-auto w-full max-w-[250px] border" src={buildLogsButtonImg} />
...
<Image className="rounded-primary mx-auto w-full max-w-[250px] border" src={codeBuildEditEnv} />
4. Expand the **Additional configuration** section, which will allow you to choose the environment configuration required.
<Image className="rounded-primary mx-auto w-full max-w-[250px] border" src={codeBuildEditEnvAdditionalConfig} />
5. Finally, click **Update Environment**

Note: this configuration will be used going forward in all your deployments for this specific project and service.
