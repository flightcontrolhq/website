...
<Note type="warning">⚠️ **static** service types are not yet supported. Make sure to omit these from the preview environment config in flightcontrol.json (see below). </Note>
      ...
      "environments": [
        ...existing environments,
        {
          ...
          "services": [
            ...
            // ⚠️ **static** service types are not yet supported
          ]
          ...rest of env config
        }
      ]
