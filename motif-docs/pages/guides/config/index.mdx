...
- Using a `.json` file, usually named `flightcontrol.json`, which needs to exist in your codebase
...
![](https://res.cloudinary.com/djp21wtxm/image/upload/v1665137948/i1552x656-Tz-a1kvS9WTs_t57dua.png)
