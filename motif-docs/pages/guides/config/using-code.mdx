...
## How do `flightcontrol.json` files fit into Flightcontrol concepts?
- A git repo can have multiple `flightcontrol.json` files each of which corresponds to a single `Project`
- A `Project` can have multiple `Environments`
- An `Environment` can have multiple `Service`'s

|`flightcontrol.json A`|                   |`flightcontrol.json B`|                   |
|---------------------|-------------------|---------------------|-------------------|
|`Project A`          |                   |`Project B`          |                   |
|`Environment A1`     | `Environment A2`  |`Environment B1`     |`Environment B2`   |
|`Service A1.a` `Service A1.b`| `Service A2.a`|`Service B1.a`|`Service B2.a` `Service B2.b` `Service B2.c`|
