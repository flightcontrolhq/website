...
- Each git repo can have multiple `flightcontrol.json` files which corresponds to a single `Project`
- A `Project` can have multiple `Environments`
- An `Environment` can have multiple `Service`'s

<table style="width:100%">
  <tr>
    <th colspan="16">GitHub</th>
  </tr>
  <tr>
    <td colspan="8">flightcontrol.json</td>
    <td colspan="8">flightcontrol.json</td>
  </tr>
  <tr>
    <td colspan="8">Project</td>
    <td colspan="8">Project</td>
  </tr>
  <tr>
