...
Image registries store the credentials or details to a registry, which you can then reference later for using a pre-built image in a Fargate service.
...
<Image
  rounded={true}
  border={true}
  src="/public/image-registry-sidebar.png"
/>
...
If you are using code to configure your app, you can copy the “Registry ID” and paste into your config. See (using-code link) for details. If you are using the UI, you can directly select the registry under the “Build System” box, and then add your repository URI and tag in the appropriate text fields.

(include picture of GUI)
