...
- <Link
  ...
  >
    <a>Namecheap (External article)</a>
  </Link>
- <Link
    target="_blank"
    rel="noopener"
  ...
  >
    <a>Google Domains (External article)</a>
  </Link>
- <Link target="_blank" rel="noopener" href="https://ca.godaddy.com/help/add-a-cname-record-19236">
    <a>GoDaddy (External article)</a>
  </Link>
