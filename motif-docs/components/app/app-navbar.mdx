...
export const LogoWithText = ({ onClick }) => {
  return <a
    ...
    className="select-none flex flex-row gap-4 items-center outline-none">
      ...
      <p className="text-base font-medium flex-grow">Flightcontrol <span className="uppercase text-xs ml-2 text-fuchsia-500">docs</span></p>
    </a>
}
      ...
      <div className="flex flex-row px-8 py-4 items-center gap-4">
        ...
        <div className="flex flex-row gap-3 items-center">
          <div className="hidden sm:flex flex-row items-center gap-5 font-medium text-sm transition">
            {config.navbar.topLinks.map((n) => {
              return <a className="whitespace-nowrap hover:text-primary-500 text-neutral-900 dark:text-white/90" href={n.href}>{n.title}</a>
            })}
          </div>
